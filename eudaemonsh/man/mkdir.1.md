...
a directory given as an operand already exists. Intermediate directories
are created with permission bits of “**rwxrwxrwx**” (0777) as modified
...
A **mkdir** command appeared in Version 1 AT&T UNIX. GNU March 15, 2013
*MKDIR*(1)
