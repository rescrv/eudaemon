...
Some shells may provide a builtin **false** command which is identical
...
The **false** utility is expected to be IEEE Std 1003.2 (“POSIX.2”)
compatible. GNU June 6, 1993 *FALSE*(1)
